...
exports.WS_EVENT_CODE_ENUM = exports.isWsPong = exports.getMaxTopicsPerSubscribeEvent = exports.getWsUrlForWsKey = exports.getWsKeyForMarket = exports.getWsKeyForTopicChannel = exports.PUBLIC_WS_KEYS = exports.PRIVATE_WS_KEYS = exports.WS_KEY_MAP = exports.WS_BASE_URL_MAP = void 0;
...
function getWsKeyForMarket(market, isPrivate, isBusinessChannel) {
    switch (market) {
        ...
        case 'colo': {
            ...
            return isPrivate ? exports.WS_KEY_MAP.coloPrivate : exports.WS_KEY_MAP.coloPublic;
        }
        case 'aws': {
            if (isBusinessChannel) {
                return isPrivate
